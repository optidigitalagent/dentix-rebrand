 ...
 try {
  for (const [width,height] of sizes) {
   ...
   await page.route('**/api/public/**', async route => {
    ...
    else if (url.pathname.endsWith('/catalog')) data = {mode:'LIVE_REQUESTS_READY',testOnly:false,timezone:'Europe/Kyiv',requestDurationMinutes:60,minDate:'2026-10-01',maxDate:'2026-10-30',consentVersion:'fixture-v1',services:[{id:'service',name:'Ізольована послуга',category:'QA fixture'}],doctors:[{id:'doctor',name:'Ізольований лікар',role_label:'QA fixture'}],doctorServices:[{doctor_id:'doctor',service_id:'service'}]};
